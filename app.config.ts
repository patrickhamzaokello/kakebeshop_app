...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  ios: {
    ...
    infoPlist: {
      ...
      NSLocationWhenInUseUsageDescription:
        "We need your location to help you set delivery addresses.",
  ...
  plugins: [
    ...
    [
      "expo-location",
      {
        locationAlwaysAndWhenInUsePermission:
          "Allow $(PRODUCT_NAME) to use your location to set delivery addresses.",
      },
    ],
    [
      "expo-camera",
    ...
    [
      ...
      {
        iosUrlScheme:
          "com.googleusercontent.apps.587787462511-lqie16rbc77p418sfpodcdffse0o8o3b",
      },
    ],
    [
      "expo-notifications",
